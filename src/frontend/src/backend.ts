...
import type { Document as _Document, ExternalBlob as _ExternalBlob, ProcessingResult as _ProcessingResult, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDocument(arg0: Document): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDocument(await to_candid_Document_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async confirmJournalEntries(arg0: string, arg1: string, arg2: Array<JournalEntry>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.confirmJournalEntries(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDocument(arg0: string): Promise<Document> {
        if (this.processError) {
            try {
                ...
                return from_candid_Document_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getProcessingResult(arg0: string): Promise<ProcessingResult | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getProcessingResult(arg0);
    ...
    async processDocumentWithAI(arg0: string, arg1: string, arg2: string): Promise<ProcessingResult> {
        if (this.processError) {
            try {
                const result = await this.actor.processDocumentWithAI(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProcessingResult]): ProcessingResult | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Document>): Promise<Array<Document>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Document_n14(_uploadFile, _downloadFile, x)));
}
async function to_candid_Document_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Document): Promise<_Document> {
