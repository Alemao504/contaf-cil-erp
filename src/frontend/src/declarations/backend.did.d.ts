...
export interface _SERVICE {
  ...
  'confirmJournalEntries' : ActorMethod<
    [string, string, Array<JournalEntry>],
    undefined
  >,
  ...
  'getProcessingResult' : ActorMethod<[string], [] | [ProcessingResult]>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'processDocumentWithAI' : ActorMethod<
